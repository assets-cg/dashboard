...
function AssigneeIssuesDashboard03() {
 ...
 useEffect( ()=>{
   const getAssigneeStories= async()=>{
   const reqData= await fetch(`${API_URL}assigneestories?project&boardId&AssigneeName=${name}`,{
    headers: {
    ...
    // <div className="col-span-full xl:col-span-12 bg-white shadow-lg rounded-sm border border-slate-200">
      <div className="col-span-full xl:col-span-12 bg-custom2 shadow-2xl rounded-3xl border-solid border-2 border-green-600 scrollTable3">
       <div className="px-5 pt-5">
        ...
        <h3 className="font-semibold text-black">Details Of Story Associated to {name}</h3>    
            ...
            <tbody className="text-sm font-medium" >
              {
                ...
                <td className="p-2">
                  <div style={{ border: '1px solid', borderRadius:'4px', color: storyDetails.storyStatus === "Done" ? "darkgreen" : storyDetails.storyStatus === "In Progress" ? "yellow" : storyDetails.storyStatus === "To Do" ? "#ff7b00" :  "red" }} className="text-center">{storyDetails.storyStatus}</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-white">{storyDetails.assignTo}</div>
                </td>
                </tr>
                )
              }
...
export default AssigneeIssuesDashboard03;