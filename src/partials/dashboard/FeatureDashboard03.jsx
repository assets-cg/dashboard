...
//    const sPercentage=[];
   ...
   const reqData= await fetch(`${API_URL}featureepictickets?project=DashboardProject&boardID=2&sprintName=${data1}&featureKey=${featureKey}`,{
    headers: {
...
export default FeatureDashboard03;
