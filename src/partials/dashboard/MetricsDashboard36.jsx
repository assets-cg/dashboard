...
const MetricsDashboard36 = ({startDate, endDate}) => {
...
const novu = new Novu(`${Novu_Api}`);
  ...
  useEffect(() => {
    ...
    for(let i=0; i<limit.length; i++){
     if("Memory Allocate/Promote" === limit[i].graphName){
  ...
  //     text: `The threshold of ${maxVal} has been exceeded. The current value is ${currentValue} for Memory Allocate/Promote Graph.`,
  //   };
  ...
  async function fetchNotification() {
    ...
    const graphName = `Memory Allocated`
  ...
  async function fetchNotification2() {
    ...
    const emailParam = 'yerpudevedant1@gmail.com'
    const graphName = `Memory Promoted`
  ...
  return (
    <div className="col-span-full xl:col-span-5 bg-custom2 shadow-2xl p-6 border-solid border-2 border-green-600 h-80 rounded-3xl ">
      <div><h2 style={{fontWeight:'600', color:'black'}}>Memory Allocate/Promote</h2></div>
       <Line data={chartData} options={chartOptions} height={350} />  
         </div>     );
};
export default MetricsDashboard36;