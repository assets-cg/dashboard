...
<div className="flex flex-col col-span-full sm:col-span-5 xl:col-span-4 bg-white shadow-2xl rounded-3xl border border-slate-200">
       {/* <LazyLoad> */}
            <iframe style={{borderRadius:"20px"}} src={`${API_LINK}d-solo/X034JGT7Gz/springboot-apm-dashboard?orgId=1&from=now-6h&to=now&theme=light&panelId=58`}  allow="insecure" width="100%" height="240" frameborder="0"></iframe>
       {/* </LazyLoad> */}
...
export default MetricsDashboard02;