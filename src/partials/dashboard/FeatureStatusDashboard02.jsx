...
function FeatureStatusDashboard02() {
...
//    const sPercentage=[];
   ...
   const reqData= await fetch(`${API_URL}meaneffortperfeaturestatusinsprint?featureKey=${featureKey}`,{
    headers: {
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-6 h-80 border-solid border-2 border-green-600  bg-custom2 shadow-2xl rounded-3xl " >
      <div className="px-5 pt-5">
        ...
        <h2 className="text-lg font-semibold text-black mb-2">Mean Effort per Epic ({epicKey})</h2>
...
export default FeatureStatusDashboard02;
