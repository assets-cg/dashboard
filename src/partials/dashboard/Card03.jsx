...
function Card03(props) {
 ...
 useEffect( ()=>{
   ...
   const reqData= await fetch(`${API_URL}sprint_epicassociated?project=DashboardProject&boardID=2&sprintId=1`,{
    headers: {
  ...
  return (
    <div className="col-span-full xl:col-span-12 bg-white shadow-2xl rounded-3xl border border-slate-200 scrollTable">
      <header className="px-5 py-4 border-b border-slate-100">
        <h3 className="font-semibold text-slate-800">Epics Associated to Sprint</h3>
      </header>
      <div className="p-3">
        {/* Table */}
        <div className="overflow-x-auto">
          <table className="table-auto w-full">
            ...
            <thead className="text-xs uppercase text-slate-400 bg-slate-50 rounded-sm">
              <tr>
                <th className="p-2">
                  <div className="font-semibold text-center">EpicId</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">EpicKey</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">EpicStatus</div>
                </th>
                {/* <th className="p-2">
            ...
            <tbody className="text-sm font-medium divide-y divide-slate-100">
              {
                ...
                <tr key={key}>
                  ...
                  <div className="flex items-center">
                    <div className="text-slate-800">{epicsAssociated.epicId}</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center">{epicsAssociated.epicKey}</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-500">{epicsAssociated.epicStatus}</div>
                </td>
                {/* <td className="p-2">
                  <div className="text-center">{epicsAssociated.summary}</div>
                </td>
                <td className="p-2">
