...
function KibanaDashboard02(props) {
    ...
    <div className="flex flex-col col-span-full sm:col-span-6 xl:col-span-12 bg-custom2 shadow-2xl border-solid border-2 border-green-600 rounded-3xl p-1 mt-4">
      <div className="px-3 pt-3">
        ...
        <div className="relative">
          ...
          <iframe
            ref={iframeRef}
            src={`https://${localStorage.getItem('ELKUrl')}:5601/app/dashboards#/view/ba205790-3fe0-11ee-a1c5-4548b53969f1?embed=true&_g=(filters%3A!()%2CrefreshInterval%3A(pause%3A!t%2Cvalue%3A0)%2Ctime%3A(from%3Anow-15m%2Cto%3Anow))&show-time-filter=true&hide-filter-bar=true`}
            height="1370"
            width={iframeWidth}
...
export default KibanaDashboard02;
