...
//   console.log(day);
 ...
 useEffect( ()=>{
   const getReleasePipelineTime= async()=>{
   const reqData= await fetch(`${API_URL}releasepipelinetime?NumberOfDays=${selectedOption}`,{
    headers: {
 ...
 setValues(resData)
   ...
   getReleasePipelineTime();
},[days, selectedOption]);
console.log(values)
  return (
    // <div className="col-span-full xl:col-span-12 bg-white shadow-lg rounded-sm border border-slate-200">
      <div className="col-span-full xl:col-span-12 bg-custom2 border-solid border-2 border-green-600  shadow-2xl rounded-3xl scrollTable3">
       <div className="px-5 pt-5">
        <header className="flex justify-between items-center mb-2">
        {/* Icon */}
        {/* <img src={Icon} width="32" height="32" alt="Icon 01" /> */}
         {/* <option value="P">{days} days</option> */}
      ...
      <h3 className="font-semibold text-black">Release Pipeline Time</h3> 
      <select
          ...
          <table className="table-auto w-full">
            ...
            <thead className="text-xs  text-black bg-slate-50 rounded-sm">
              <tr>
                ...
                <th className="p-2">
                  <div className="font-semibold text-center">Job Id</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Start Time</div>
                </th>
                <th className="p-2">
                  <div className="font-semibold text-center">Build Time In Sec</div>
                </th>
                {/* <th className="p-2">
            ...
            <tbody className="text-sm font-medium">
              {
                ...
                <tr key={key}>
                  ...
                  <div className="flex items-center">
                    <div className="text-white">{val.task}</div>
                  </div>
                </td>
                <td className="p-2">
                  <div className="text-center text-green-700">{val.jobId}</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-white">{val.startTime}</div>
                </td>
                <td className="p-2">
                  <div className="text-center text-sky-600">{val.releaseTimeInSecond}</div>
                </td>
                </tr>
                )
              }
...
export default JenkinsDashboard04;