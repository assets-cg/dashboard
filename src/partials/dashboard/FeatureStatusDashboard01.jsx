...
function FeatureStatusDashboard01() {
 ...
 useEffect( ()=>{
   ...
   const reqData= await fetch(`${API_URL}featurestatustoepicdetails?featureKey=${featureKey}`,{
    headers: {
 ...
 console.log(resData.epicDetails)
   }
   getEpicDetails();
},[[featureKey, values]]);
console.log(values)
...
export default FeatureStatusDashboard01;