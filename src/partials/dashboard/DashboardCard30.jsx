...
//    const sPercentage=[];
   ...
   const reqData= await fetch(`${API_URL}epicstorycount?projectName=${localStorage.getItem("projectName")}&BoardId=${localStorage.getItem("boardId")}`,{
    headers: {
   ...
   for(var i=0;i<resData.epicDetails.length;i++){
    ...
    sEfforts.push(resData.epicDetails[i].count);
   }   
  ...
  return (
    <div className="flex flex-col col-span-full sm:col-span-6 bg-custom2 shadow-2xl border-solid border-2 border-green-600 rounded-3xl">
      ...
      <div className="flex items-center">
        <h2 className=" font-semibold text-black mr-2">Epic wise Story Count</h2>
  </div>
      </header>
...
export default DashboardCard30;
