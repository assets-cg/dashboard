...
function FeatureStatusDashboard04() {
...
//    const sPercentage=[];
   ...
   const reqData= await fetch(`${API_URL}featurestatusepiceffort?featureKey=${featureKey}`,{
    headers: {
...
export default FeatureStatusDashboard04;
