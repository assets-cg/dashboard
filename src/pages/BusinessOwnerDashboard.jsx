...
import BusinessDashboardCard02 from '../partials/dashboard/BusinessDashboardCard02';
import BusinessDashboardCard03 from '../partials/dashboard/BusinessDashboardCard03';
...
function BusinessOwnerDashboard() {
  ...
  useEffect(() => {
    const checkIfAdmin = async () => {
      ...
      if (groups && (groups.includes("Business_Owner") || groups.includes("Admin"))) {
        setIsAdmin(true);
      }
    };
    ...
    return (
      ...
      <div className="flex flex-col items-center justify-center h-screen">
        ...
        <div className="text-center">
          ...
          <p className="text-xl mt-4">Only <b>Business Owner</b> access accepted</p>
        </div>
      </div>
      </div>
    );
          ...
          <div className="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
            ...
            <div className="sm:flex sm:justify-between sm:items-center mb-8">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2">
                ...
                {/* Add view button */}
                <span><label style={{fontWeight:"bold", fontSize:'20px'}}>Business Owner Dashboard <div className ='absolute right-10 -mt-6'>{tokenExpiry === "Expired JWT token" || tokenExpiry ==="Invalid JWT token" && (
        ...
        <Alert severity='error'>
          Alert : <strong>JWT Token Expired / Invalid</strong>
            ...
            <div className="grid grid-cols-12 gap-3">
              ...
              <BusinessDashboardCard03 />
              <BusinessDashboardCard02 />
              <DashboardCard19 />
              <DiscussionWidget />
            </div>
