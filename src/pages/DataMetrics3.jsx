          ...
          {/* <SignOutButton/> */}
            ...
            <div className="sm:flex p-2 sm:justify-between sm:items-center mb-2">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2 mt-5">
                ...
                <span><label style={{fontWeight:"bold", fontSize:'20px'}}>HTTP Statistics Details </label> &nbsp;
             
  </span>   
  <div className='inline-block absolute right-36 w-80 flex items-center'>
  <div class="relative">
  <button class="bg-white text-white border-gray-300 border rounded-md px-1 py-1" onClick={() => setShowDiv(!showDiv)}>📆</button> 
  {showDiv && (
...
<hr className='mt-2 border-gray-800 dark:border-gray-400'></hr>
  ...
  <div className="relative flex items-center">
    <div className='rounder border border-gray-300' style={{color:'white', marginRight: '2px', marginLeft: '2px'}}>
    <Flatpickr
      id="start-date"
    ...
    /></div>
            ...
            <div className="grid grid-cols-12 gap-3">
              ...
              {/* <MetricsDashboard50 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/> */}
               <ApiDashboard01 />
              <MetricsDashboard41 interval={interval} startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
