...
import MetricsDashboard31 from '../partials/dashboard/MetricsDashboard31';
import MetricsDashboard32 from '../partials/dashboard/MetricsDashboard32';
import MetricsDashboard33 from '../partials/dashboard/MetricsDashboard33';
import MetricsDashboard34 from '../partials/dashboard/MetricsDashboard34';
import MetricsDashboard35 from '../partials/dashboard/MetricsDashboard35';
import MetricsDashboard36 from '../partials/dashboard/MetricsDashboard36';
          ...
          {/* <SignOutButton/> */}
            ...
            <div className="sm:flex p-2 sm:justify-between sm:items-center mb-2">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2 mt-5">
                ...
                <span><label style={{fontWeight:"bold", fontSize:'20px'}}>JVM Statistics - Memory </label> &nbsp;
...
<hr className='mt-2 border-gray-800 dark:border-gray-400'></hr>
  ...
  <MetricsDashboard31 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
  <MetricsDashboard32 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
  <MetricsDashboard33 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
  <MetricsDashboard34 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
  <MetricsDashboard36 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
  <MetricsDashboard35 startDate={new Date(startDate).getTime()/1000} endDate={new Date(endDate).getTime()/1000} jobName={jobName}/>
