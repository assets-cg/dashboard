...
function ServiceDeliveryManager() {
          ...
          {/* <SignOutButton/> */}
            ...
            <div className="sm:flex p-2 sm:justify-between sm:items-center mb-2">
              ...
              <div className="grid grid-flow-col sm:auto-cols-max justify-start sm:justify-end gap-2 mb-3">
                ...
                <span><label style={{fontWeight:"bold", fontSize:'20px'}}>Service Delivery Dashboard <NotificationBell2/> <div className ='absolute right-10 -mt-8'>{tokenExpiry === "Expired JWT token" || tokenExpiry ==="Invalid JWT token" && (
